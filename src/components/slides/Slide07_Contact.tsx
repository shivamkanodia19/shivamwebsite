      ...
      <div className="flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-6 font-mono text-[9px] uppercase tracking-[0.3em] text-[#555]"
          >
        ...
        >
          {links.map((link, i) => (
            ...
            >
              <span className="w-16 shrink-0 font-mono text-[9px] uppercase tracking-[0.25em] text-[#555]">
                {link.label}
              </span>
              <a
                href={link.href}
                ...
                className="font-mono text-[12px] text-[#999] no-underline transition-colors duration-150 hover:text-[#F5F2EE] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#555]"
              >
                {link.display}
              </a>
            </motion.div>
